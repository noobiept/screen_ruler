...
class OptionsWindow( QWidget ):
    ...
    def __init__( self, rulerObject ):
        ...
        backgroundColorElement = color_button.ColorButton( self, 'Background', backgroundColor, updateBackgroundColor )
        linesColorElement = color_button.ColorButton( self, 'Lines', linesColor, updateLinesColor )
